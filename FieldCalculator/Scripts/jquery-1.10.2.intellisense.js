...
intellisense.annotate(jQuery, {
  ...
  'extend': function() {
    ...
    ///   <param name="objectN" type="Object">FieldCalculatoral objects containing properties to merge in.</param>
    ///   <returns type="Object" />
    /// </signature>
    /// <signature>
    ///   <summary>Merge the contents of two or more objects together into the first object.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'trigger': function() {
    ...
    ///   <param name="extraParameters" type="PlainObject">FieldCalculatoral parameters to pass along to the event handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Execute all handlers and behaviors attached to the matched elements for the given event type.</summary>
